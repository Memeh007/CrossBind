"""CrossBind FastAPI application — local molecular docking."""
...
app = FastAPI(title="CrossBind", version=__version__, docs_url=None, redoc_url=None)
...
@app.get("/api/health")
async def health():
    return {"ok": True, "app": "CrossBind", "version": __version__, **_engine_status()}
